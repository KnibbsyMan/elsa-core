...
//namespace Elsa.Sql.Endpoints.TypeDefinitions;

///// <summary>
///// Returns a SQL definitions that are used by the Monaco editor to display intellisense for SQL expressions.
///// </summary>
//[PublicAPI]
...
//    {
//        Post("scripting/sql/type-definitions/{workflowDefinitionId}");
//        ConfigurePermissions("read:*", "read:sql-type-definitions");
//    }
